...
import LoaderDemo from './LoadDemo/LoaderDemo.jsx';
...
import CustomFormDemo from './CustomForm/CustomFormDemo.jsx';
      ...
      <div>
        <nav className="navbar navbar-expand-lg navbar-dark ">
           ...
           <ul className="navbar-nav mr-auto">
            ...
            <li><Link to="/genericcontainer">Generic Container</Link></li>
